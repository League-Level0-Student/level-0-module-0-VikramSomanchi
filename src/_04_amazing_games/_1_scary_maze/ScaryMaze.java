...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (started) {
			...
			int victoryColor = -5317;
			if(mouseColor==victoryColor) {
				JOptionPane.showMessageDialog(null, "Woo, you finished the maze");
			}	
	...
	private void scare() {
		...
		showScaryImage("eternatas.png");
		JOptionPane.showMessageDialog(null, "You probably need to get better at mazes");
	}
